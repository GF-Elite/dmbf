...
# Copyright© GF-Elite ID 2021


# Author : GF-ELite
# Facebook (GF-Elite)   : Facebook.com/kananda.widiantara.50
# Instagram (☬ 𝐀𝐧𝐨𝐧𝐲𝐦 𝟒𝟎𝟒 ☬)    : Instagram.com/andika_12124123
# Whatsapp (GF-Elite Bot_Key)      : +6281375182098
# YouTube (Xayonara.ID)           :  https://youtube.com/channel/UCgPmKTDUz08kL6PxEFf6nIg
...
_logo_line_3_ = ('%s| |) | |\/| | _ \ _|  %s│   %s• Code By GF-Elite •   %s│'%(_P_,_U_,_P_,_U_))
_logo_line_4_ = ('%s|___/|_|  |_|___/_|   %s│ %sGithub.com/GF-Elite/dmbf %s│'%(_P_,_U_,_P_,_U_))
